...
- [Test Plugins](how-to/test-plugins.md)
- [Method and Trait Metadata](how-to/method-metadata.md)
...
- [fidius-core](api/rust/fidius-core.md) — Descriptors, wire format, hashing, registry, metadata types
- [fidius-macro](api/rust/fidius-macro.md) — Proc macros and IR
- [fidius-host](api/rust/fidius-host.md) — Loading, calling, signing, arch detection, arena pool
- [fidius-cli](api/rust/fidius-cli.md) — CLI commands
- [fidius-test](api/rust/fidius-test.md) — Testing helpers (dylib_fixture, signing fixtures)
