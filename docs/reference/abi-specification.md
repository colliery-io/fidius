...
| 40 | 1 | `wire_format` | `u8` | `0` = Json, `1` = Bincode. See [Wire Format](#wire-format). |
...
- [#[plugin_interface] Reference](./plugin-interface-macro.md) -- macro that generates vtable and constants
- [#[plugin_impl] Reference](./plugin-impl-macro.md) -- macro that generates shims and descriptors
- [Host API Reference](./host-api.md) -- host-side loading API
