...
| `ABI_VERSION` | `300` (at fidius-core 0.3.0) | Layout version of the `PluginDescriptor` struct. |
...
| 4 | 4 | `abi_version` | `u32` | Must equal `ABI_VERSION` (e.g., `300` for fidius-core 0.3.0). |
