...
| `08_host_functions` | **Host functions** — the plugin calls back into the host mid-execution (`#[host_interface]`): release/reclaim a host-owned slot, the reentrant host → plugin → host path. |
