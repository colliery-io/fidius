...
- **2026-03-29**: Implemented in `fidius-macro/src/ir.rs`. InterfaceIR, MethodIR, InterfaceAttrs all working. Parses version/buffer attrs, optional(since=N), async detection, &mut self rejection, 64 optional limit. 6 unit tests pass.