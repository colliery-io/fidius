---
id: fidius-facade-end-to-end-validation
level: initiative
title: "fides Facade + End-to-End Validation"
short_code: "FIDIUS-I-0004"
...
initiative_id: fidius-facade-end-to-end-validation
---

# fidius Facade + End-to-End Validation

## Context

The facade crate (`fidius`) is a thin re-export layer so interface crates have a single dependency. The real work in this initiative is the end-to-end integration test: build an interface crate, implement a plugin as a cdylib, load it from a host binary, call methods, and verify everything works — including optional methods, async, signing, and multi-plugin-per-dylib.

This initiative is the proof that initiatives 1–3 actually work together. It's small in code but high in signal.

Depends on FIDIUS-I-0001, FIDIUS-I-0002, FIDIUS-I-0003.

## Goals & Non-Goals

**Goals:**
- `fidius` facade crate: re-export `fidius_core::*` types and `fidius_macro::*` macros
...
- CLI integration tests (FIDIUS-I-0005)
...
// fidius/src/lib.rs
pub use fidius_core::*;
pub use fidius_macro::{plugin_interface, plugin_impl};
```
