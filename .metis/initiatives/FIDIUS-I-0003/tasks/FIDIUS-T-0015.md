...
### Dependencies
- FIDIUS-T-0013 (types), FIDIUS-T-0014 (loader)

## Status Updates

- **2026-03-29**: Implemented in `fidius-host/src/host.rs`. Builder with all chainable methods, `discover()` scans directories for platform-appropriate dylibs, `load(name)` finds specific plugin. Platform-aware extension check (dylib/so/dll). Compiles clean.