...
File: `fidius-host/src/signing.rs`
...
### Dependencies
- FIDIUS-T-0013 (LoadError types)

## Status Updates

- **2026-03-29**: Implemented in `fidius-host/src/signing.rs`. `verify_signature()` reads dylib + .sig, verifies against trusted keys. 4 unit tests pass: valid sig succeeds, tampered file fails, wrong key fails, missing sig returns SignatureRequired.