---
id: fidius-host-loading-and-calling
level: initiative
title: "fidius-host — Loading and Calling"
short_code: "FIDIUS-I-0003"
...
initiative_id: fidius-host-loading-and-calling
---

# fidius-host — Loading and Calling
...
Depends on FIDIUS-I-0001 (core types) and FIDIUS-I-0002 (macro generates the types this crate validates against).
...
The macro (FIDIUS-I-0002) generates a trait-specific `PluginHandle` impl. fidius-host provides the generic machinery:
...
- Integration tests require a compiled cdylib plugin — deferred to FIDIUS-I-0004
